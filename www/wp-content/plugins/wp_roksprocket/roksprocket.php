<?php
/**
 * @version   $Id: roksprocket.php 18154 2014-01-26 17:51:44Z jakub $
...
if (!defined('ROKSPROCKET_VERSION')) define('ROKSPROCKET_VERSION', '2.0.6');
...
if (!preg_match('/project.version/', ROKCOMMON) && version_compare(preg_replace('/-SNAPSHOT/', '', ROKCOMMON), ROKSPROCKET_NEEDED_ROKCOMMON_VERSION, '<')) {
	rs_force_deactivate();
	roksprocket_set_admin_message('error', __('RokSprocket v2.0.6 needs at least RokCommon Version ' . ROKSPROCKET_NEEDED_ROKCOMMON_VERSION . '.  You currently have RokCommon Version ' . ROKCOMMON));
	return;
}
