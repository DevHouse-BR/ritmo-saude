<?php
/**
 * @version   $Id: list.php 18463 2014-02-04 14:34:14Z jakub $
    ...
    <div style="margin: 0 auto;">
        ...
        <table cellspacing="0" class="wp-list-table widefat fixed" style="margin: 0 auto;">
					...
					<th class="manage-column column-title <?php echo strtolower($order); ?> <?php echo ($that->orderby == 'title') ? 'sorted' : 'sortable'; ?>">
						<div class="sort<?php echo ($that->orderby == 'title') ? ' active' : ''; ?>">
							<a href="<?php echo RokCommon_URL::updateParams($that->link, array('orderby' => 'title', 'order' => $order));?>"
							  title="Order by Title">Title<span class="sorting-indicator"></span></a>
						</div>
					</th>
					...
					<th class="manage-column column-modified <?php echo strtolower($order); ?> <?php echo ($that->orderby == 'modified') ? 'sorted' : 'sortable'; ?>">
						<div class="sort<?php echo ($that->orderby == 'modified') ? ' active' : ''; ?>">
							<a href="<?php echo RokCommon_URL::updateParams($that->link, array('orderby' => 'modified', 'order' => $order));?>"
							  title="Order by Modified Date">Last Modified<span class="sorting-indicator"></span></a>
						</div>
					</th>
					...
					<th class="manage-column column-id <?php echo strtolower($order); ?> <?php echo ($that->orderby == 'id') ? 'sorted' : 'sortable'; ?>">
						<div class="sort<?php echo ($that->orderby == 'id') ? ' active' : ''; ?>">
							<a href="<?php echo RokCommon_URL::updateParams($that->link, array('orderby' => 'id', 'order' => $order));?>"
							  title="Order by Id">Id<span class="sorting-indicator"></span></a>
						</div>
					</th>
				</tr>
            </thead>
            ...
            <tr class="<?php echo (($j % 2 == 0) ? 'alternate ' : '');?>iedit">
                ...
                <td>
                    <div class="relative">
                        <div class="single-layout"><i data-dynamic="false" class="icon provider <?php echo strtolower($results->provider);?>"></i><?php echo $results->displayname;?>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="relative">
                        <div class="single-layout"><i data-dynamic="false" class="icon layout <?php echo strtolower($results->layout);?>"></i><?php echo ucwords($results->layout);?>
                        </div>
                    </div>
                </td>
                <td>
